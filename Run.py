...
# if a video path was not supplied, grab reference to the camera
...
while True:
	...
	for (i, (prob, bbox, centroid)) in enumerate(results):
		...
		# draw a bounding box around the person and (2) the  centroid coordinates of the person
...
# Alert function
	if len(serious) >= config.Threshold:
		cv2.putText(frame, "-ALERT: Violations over limit-", (10, frame.shape[0] - 1),
